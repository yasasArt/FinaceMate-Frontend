...
import { HandCoins, DollarSign, Package, PencilLine, Star, Trash, TrendingUp, Users } from "lucide-react";
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div className="card">
                    ...
                    <div className="card-body bg-slate-100 transition-colors dark:bg-[#9c8feffc]">
                        ...
                        <span className="flex w-fit items-center gap-x-2 rounded-full border border-blue-500 px-2 py-1 font-medium text-white dark:border-white dark:text-white">
                            <TrendingUp size={18} />
                            25%
                        </span>
                    </div>
